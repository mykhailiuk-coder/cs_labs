...
public class FreeSoftware : Software
{
    ...
    string manufacturer;
    FreeSoftware(string name, string description, string code, Date releaseDate, int functionalityLevel, string manufacturer) : base(name, description, code, releaseDate)
    {
...
public class PartiallyFreeSoftware : Software
{
    decimal price;
    string vendor;
    PartiallyFreeSoftware(string name, string description, string code, Date releaseDate, decimal price, string vendor) : base(name, description, code, releaseDate)
    {
        this.price = price;
        this.vendor = vendor;
    }
...
public class PaidSoftware : Software
{
    ...
    Date installDate;
    string vendor;
    PaidSoftware(string name, string description, string code, Date releaseDate, decimal price, string vendor, Date expirationDate, Date installDate) : base(name, description, code, releaseDate)
    {
        this.price = price;
        this.vendor = vendor;
